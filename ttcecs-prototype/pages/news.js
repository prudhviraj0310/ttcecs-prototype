        ...
        {newsItems.length > 0 && (
          <section className="py-16 px-6">
            <div className="max-w-7xl mx-auto">
              ...
              >
                <div className={`bg-gradient-to-r ${newsItems[0].color || 'from-blue-500 to-indigo-600'} p-8 md:p-12`}>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {newsItems.slice(1).map((news, idx) => (
                  ...
                  >
                    <div className={`bg-gradient-to-r ${news.color || 'from-gray-500 to-gray-600'} p-6`}>
