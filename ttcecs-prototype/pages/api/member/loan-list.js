...
const MOCK_LOANS = {
    '12345': [
        { LNo: 'LN001', LMNo: '12345', LType: 'Personal Loan', LAmt: 200000, LBal: 125000, LROI: 10.5, LDt: '2023-06-01', LStatus: 'Active', EMI: 8500, Tenure: 24 },
    ],
    '1001': [
        { LNo: 'LN002', LMNo: '1001', LType: 'Vehicle Loan', LAmt: 500000, LBal: 350000, LROI: 9.5, LDt: '2023-01-15', LStatus: 'Active', EMI: 15000, Tenure: 36 },
    ],
    '1002': [],
};
...
export default async function handler(req, res) {
    ...
    if (MOCK_LOANS[mno] !== undefined) {
        ...
        return res.status(200).json({ loans: MOCK_LOANS[mno], mockMode: true });
    }
